...
- ✅ Application is fully functional without authentication or authorization.
- ✅ No Spring Security configuration is present.
- ✅ APIs are accessible without login.
...
> More checkpoints will be added as the project progresses.