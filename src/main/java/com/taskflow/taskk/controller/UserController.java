...
@GetMapping("/fetch-all-users")
    ...
    public ResponseEntity<BaseApiResponse<UserResponseDto>> getUserById(@PathVariable Long id) {
    ...
    @PatchMapping("/update-user/{id}")
     public ResponseEntity<BaseApiResponse<UserResponseDto>> updateUserById(@PathVariable Long id, @RequestBody UserRequestDto userRequestDto) {
    ...
    public ResponseEntity<BaseApiResponse<Void>> deleteUserById(@PathVariable Long id) {
    ...
    public ResponseEntity<BaseApiResponse<Void>> activateUserAccount(@PathVariable Long id) {
    ...
    public ResponseEntity<BaseApiResponse<Void>> deactivateUserAccount(@PathVariable Long id) {
